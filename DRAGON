...
if res ~= 200 then
print('\27[0;31m≪━━━━━━ 𝗦𝗧𝗔𝗥𝗞  ━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━ 𝗦𝗧𝗔𝗥𝗞  ━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━ 𝗦𝗧𝗔𝗥𝗞  ━━━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1211544689,1211544689,1211544689}   
...
var = true  
elseif tonumber(user_id) == tonumber(1211544689) then
var = true  
...
if tonumber(user_id) == tonumber(1211544689) then  
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(1211544689) then
var = 'مالك السورس'
elseif tonumber(user_id) == tonumber(1211544689) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝗦𝗧𝗔𝗥𝗞 ")  
...
{{text = '𝗦𝗧𝗔𝗥𝗞 ', url="t.me/TT_4T4"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '⩹━━━━━━ 𝗦𝗧𝗔𝗥𝗞  ━━━━━━⩺' or text == '⩹━━━━━━ 𝗦𝗧𝗔𝗥𝗞  ━━━━━━⩺' or text == '⩹━━━━━━ 𝗦𝗧𝗔𝗥𝗞  ━━━━━━⩺' or text == '"' then
local Text =[[
تواصل السورس ☑️
]]
keyboard = {} 
...
{
{text = '۞ قنات سورس متميزه  ۞ ', url = "https://t.me/TT_4T4"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TT_4T4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
۞- [اهلا بك في سورس نايت الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ](t.me/TT_4T4) ۞
...
╭────────╮
 ...
 [☭ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗧𝗔𝗥𝗞 ☭](t.me/TT_4T4)
             
╰────────╯
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '☭ 𝗗𝗘𝗩 𝗦𝗧𝗔𝗥𝗞 ☭',url="t.me/TT_4T4"}},  
{{text = '☭ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗧𝗔𝗥𝗞 ☭',url="t.me/TT_4T4"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TT_4T4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1211544689) then  
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1211544689) then
send(msg.chat_id_, msg.id_, " ☭ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1211544689) then  
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/TT_4T4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/TT_4T4)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔??](t.me/TT_4T4)') 
return false
end

if text == 'مين' then 
send(msg.chat_id_,msg.id_, '[مش لازم تعرف يجميل 😂](t.me/TT_4T4)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/TT_4T4)') 
return false
end

if text == 'قفل المحن' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[تم قفل المحن يكسمك 😂](t.me/TT_4T4)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/TT_4T4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/TT_4T4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/TT_4T4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/TT_4T4)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/TT_4T4)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/TT_4T4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/TT_4T4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/TT_4T4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/TT_4T4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/TT_4T4)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/TT_4T4)') 
return false
end
end
end
...
{
{text = '𝗦𝗧𝗔𝗥𝗞 ', url="t.me/TT_4T4"},
{text = 'مبرمج السورس', url="t.me/TT_4T4"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
