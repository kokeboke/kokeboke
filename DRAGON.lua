...
------by-vivaz---- by--- vivaz ------byvivaz-------hacker-----soucer----vivaz
...
if res ~= 200 then
print('\27[0;31m⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,779108237,779108237,400099998887777,10589490701058949070}   
...
if tonumber(user_id) == tonumber(779108237) then  
var = true  
elseif tonumber(user_id) == tonumber(779108237) then
var = true  
...
local UserName = (data.username_ or "TT_4T4")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩 𝗧𝗪𝗟𝗬𝗡 𓏴   𓆪.")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'تولين') 
local DRAGON_Msg = { 
...
send(msg.chat_id_, msg.id_,' ★ اصدار سورس تولين { S:12✓}')
end


if text == '⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس تولين ادخل وتابع الجديد](t.me/TT_4T4)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TT_4T4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/TT_4T4)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
14• تفعيل البوت الخدمي { يمكن هذا امر ان منشئ الكروب يفعل البوت م̷ـــِْن دون حتياجه لمطور البوت
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/TT_4T4"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ★ من أحسن السورسات على التليجرام سورس تولين ★
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TT_4T4/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'★ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TT_4T4')..') \n★ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"★ العضو : {["..data.first_name_.."](T.ME/TT_4T4)}\n★ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","انيكك","كس اختك","انيك","اختك","امك"}
for k,v in pairs(list) do
...
send(msg.chat_id_,0, "★ عذرا » {["..data.first_name_.."](T.ME/TT_4T4)}\n★ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝗧𝗪𝗟𝗬𝗡 ⍟
╭──── • ◈ • ────╮

么 [𝗔𝗦𝗞 𝗧𝗢 𝗠𝗘](t.me/VV_000_VV)
么 [𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗪𝗟𝗬𝗡](t.me/TT_4T4)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗕𝗔𝗥𝗟𝗢', url="t.me/VV_000_VV"}},
{{text = '𝘾𝙃 𝘽𝘼𝙍𝙇𝙊', url="t.me/TT_4T4"}},

{ {text = 'اضف البوت لمجموعتك 🌚💞', url="http://t.me/"..sudos.UserName.."?startgroup=new"}, },

}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/TT_4T4/2107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'★ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TT_4T4')..') \n★ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'★ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TT_4T4')..') \n★ تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == 'تفعيل الحمايه القصوى'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
database:set(bot_id.."lock:AddMempar"..msg.chat_id_,'kick')
database:set(bot_id.."lock:Join"..msg.chat_id_,'kick')
database:set(bot_id.."lock:Bot:kick"..msg.chat_id_,'kick')
...
database:set(bot_id.."lock:Sticker"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'تم قفل الحمايه كامله\nتحظير هذا الحمايه تقفل كل حاجه بلتقييد\nتفعيل الحمايه دي بس عند التفليش او التحفيل\nلتعطيل الحمايه القصوى\nاكتب تعطيل الحمايه القوصه\n تم تفعيل الحمايه القصوى من قبل [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
if text == 'تعطيل الحمايه القصوى'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:del(bot_id.."lock:Spam"..msg.chat_id_)  
database:del(bot_id.."lock:Join"..msg.chat_id_)  
database:del(bot_id.."lock:text"..msg.chat_id_)  
database:del(bot_id.."lock:AddMempar"..msg.chat_id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوى من قبل    [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
if tonumber(result.sender_user_id_) == tonumber(779108237) then  
...
if result.id_ == tonumber(779108237) then
...
if tonumber(userid) == tonumber(779108237) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(779108237) then  
...
if Get_info then
local TextS = "\n★ اهلا بك في متجر ملفات VIP\n★ ملفات السورس ↓\n⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚\n\n"
local TextE = "\n⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚\n★ علامة تعني { ✔️ } ملف مفعل\n★ علامة تعني { ✖ } ملف معطل\n★ قناة سورس سVIP ↓\n".."★ [اضغط هنا لدخول](t.me/TT_4T4) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"★ عذرا الملف لايدعم سورس VIP \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n★ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TT_4T4')..')'
status  = '\n★ تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n★ العضو » ['..result.title_..'](t.me/'..(username or 'TT_4T4')..')'
status  = '\n★ تم ترقيته مطور'
texts = usertext..status
else
texts = '★ لا يوجد حساب بهذا المعرف'
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع تولين") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع تولين @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع تولين @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"★︙ عذرا عزيزي المستخدم هذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^رفع تولين (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع تولين (%d+)$")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n★ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TT_4T4')..')'
status  = '\n★ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n★ العضو » '..userid..''
...
if AddChannel(msg.sender_user_id_) == false then
local TT_4T4 = database:get(bot_id..'text:ch:user')
if TT_4T4 then
send(msg.chat_id_, msg.id_,'['..TT_4T4..']')
else
send(msg.chat_id_, msg.id_,' ★ لا تستطيع استخدام البوت \n  ★ يرجى الاشتراك بالقناه اولا \n  ★ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
----------------------------------------- انتهاء كشف المجموعة
if text == 'VIP التولين' and Mod(msg) then    
...
'\n ≪ـــــــــــــــــــــ𓆩 𓏴  𝗧𝗪𝗟𝗬𝗡 𓆪ـــــــــــــــــــــ≫ٴ'..
...
' }\n'..'𖤛︙  الرفع » { '..setadd..
' }\n'..'𖤛︙  الحظر » { '..banm..' }\n\nٴ≪ـــــــــــــــــــــ𓆩 𝗧𝗪𝗟𝗬𝗡 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n𖤛︙ قناة سورس الوون ↓\n [ ❍ ┇𓆩 𝗧𝗪𝗟𝗬𝗡 𓏴   𓆪.](t.me/TT_4T4) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
local f = '★ عدد البوتات التي هي ادمن >> {'..t..'}\n★ ملاحظه علامة ال (✯) تعني ان البوت ادمن \n'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n★ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TT_4T4')..')'..'\n★ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."TT_4T4:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'★ تم تفعيل الانستا')
database:set(bot_id.."TT_4T4:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."TT_4T4:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TT_4T4:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"★︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."TT_4T4:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."TT_4T4:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تولين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تولين')
local DRAGON_Msg = {
'نعم يروحي 😻♥️',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TT_4T4')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,'⚠| لا استطبع صيح معرفات المجموعـات') 
return false  
end
if result.id_ then
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/TT_4T4 "},
},
{
{text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..sudos.UserName.."?startgroup=new"},
},
...
send(msg.chat_id_, msg.id_, t..'⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚\nاضغط علي الاسم ليتم نسخه\n⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚\n ★ ❲[𝙰𝙻𝙴 ☽‘](t.me/VV_000_VV)❳ ★ ')
end
...
⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚
★ اليك الاوامر الخاص بسورس تولين .
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تولين')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/TT_4T4)') 
return false
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"قل لواحد ماتعرفه عطني كف 🧸","🧸سو مشهد تمثيلي عن وحدة بتولد","🧸صور اي شيء يطلبه منك الاعبين","🧸البس طرحه امك او اختك ","🧸لا خلاص معتش في سمحتك"," 🧸اتصل لاخوك و قول له انك سويت حادث و الخ....","🧸تكلم باللغة الانجليزية الين يجي دورك مرة ثانية لازم تتكلم اذا ما تكلمت تنفذ عقاب ثاني","🧸تروح عند شخص تقول له ","🧸 اتصل على ابوك و قول له انك رحت مع بنت و احين هي حامل....","🧸اتصل على امك و قول لها انك ","🧸اذا انت ولد اكسر اغلى او احسن عطور عندك اذا انتي بنت اكسري الروج حقك او الميك اب حقك"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[انت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂★](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/TT_4T4)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/TT_4T4)') 
return false
end
...
"صراحه  |  أشعر تولينحدة على الرغم من أنني تحيط بك كثيرا؟",
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/VV_000_VV/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/TT_4T4/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendDocument?chat_id=' .. msg.chat_id_ .. '&document=https://t.me/themes/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚
★ 𝘾𝙃 - [𓌹 ᯓ المبرمج تولين ★ 𓌺](t.me/VV_000_VV) 
⚚━━━━━⚚ 𝗧𝗪𝗟𝗬𝗡 ⚚━━━━━⚚
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{
{text = 'المبرمج تولين',url="t.me/VV_000_VV"}
},  
{{text = '𝗧𝗪𝗟𝗬𝗡', url="t.me/TT_4T4"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/VV_000_VV&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end



if text == 'بوب' or text == 'هكر' then  
local Text = [[
للتواصل 🔴 مع المبرمج بوب 🌚💞
اضغط 🔴 علي الازرار الي تحت 🌚💞

]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{
{text = '𝙳𝙴𝚅 VIVAZ 🌚💞 ',url="t.me/VV_000_VV"}
},  

{{text = '𝗧𝗪𝗟𝗬𝗡', url="t.me/TT_4T4"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/VV_000_VV/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب تولين ' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '★قنـآة السـورس ★', url="https://t.me/TT_4T4"},{text = '★مــبـرمج السورس ★', url="https://t.me/M_S_U"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TT_4T4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
